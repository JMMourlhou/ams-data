from ._anvil_designer import ItemTemplate4_copyTemplate
from anvil import *
...
class ItemTemplate4_copy(ItemTemplate4_copyTemplate):
    def __init__(self, mode="TestQcm", **properties):               # "TestQcm" = mode test, sinon, création
