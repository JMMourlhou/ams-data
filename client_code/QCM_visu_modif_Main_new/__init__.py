from ._anvil_designer import QCM_visu_modif_Main_newTemplate
from anvil import *
...
class QCM_visu_modif_Main_new(QCM_visu_modif_Main_newTemplate):
    def __init__(self, qcm_descro_nb=None, **properties):
        ...
        self.drop_down_nb_options.items=["V/F", "2 options", "3 options", "4 options", "5 options"]
    ...
    def drop_down_nb_options_change(self, **event_args):
        """This method is called when an item is selected"""
        choix = int(self.drop_down_bareme.selected_value)
        if choix == "V/F":
